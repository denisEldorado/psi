 ...
 */
@Entity
@Table(name = "ADM_VERIFICATION_TOKEN")
public class VerificationTokens {
    ...
    @Id
    @SequenceGenerator(name = "ADM_VER_TOKEN_SEQ_GEN", sequenceName = "ADM_VER_TOKEN_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "ADM_VER_TOKEN_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Column(name = "ID")
    public Long getId() {
        return id;
    }
    ...
    public boolean equals(Object o) {
        ...
        VerificationTokens that = (VerificationTokens) o;
