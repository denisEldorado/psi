 ...
 */
@Entity
@Table(name = "DAT_BENEFICIARY_TYPES")
public class BeneficiaryTypes {
    private Long id;
    ...
    @Id
    @SequenceGenerator(name = "DAT_BENEFICIARY_TYPES_SEQ_GEN", sequenceName = "DAT_BENEFICIARY_TYPES_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_BENEFICIARY_TYPES_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object o) {
        ...
        BeneficiaryTypes that = (BeneficiaryTypes) o;
