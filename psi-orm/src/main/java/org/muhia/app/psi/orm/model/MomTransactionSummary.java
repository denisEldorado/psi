 ...
 */
@Entity
@Table(name = "FCT_MOM_TRANSACTION_SUMMARY")
public class MomTransactionSummary {
    private Long id;
    private String accounttype;
    private String totalgsmexpenditure;
    private String totalamdebits;
    private String totalamcredits;
    ...
    @Basic
    @Column(name = "ACCOUNTTYPE", nullable = true, length = 150)
    ...
    @Basic
    @Column(name = "TOTALGSMEXPENDITURE", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALAMDEBITS", nullable = true, length = 350)
    public String getTotalamdebits() {
        return totalamdebits;
    }

    public void setTotalamdebits(String totalamdebits) {
        this.totalamdebits = totalamdebits;
    }

    @Basic
    @Column(name = "TOTALAMCREDITS", nullable = true, length = 350)
    public String getTotalamcredits() {
        return totalamcredits;
    }

    public void setTotalamcredits(String totalamcredits) {
        this.totalamcredits = totalamcredits;
    }

    @Basic
    @Column(name = "TOTALSMS", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALUSSD", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALVOICECALLS", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALROAMINGCF", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALCONTENTDOWNLOAD", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALHYBRIDBUNDLES", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALMMS", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALCF", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALGPRS", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALDATA", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALCASHIN", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALCASHOUT", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALAMTOPUP", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALMERCHANTPAYMENTS", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALP2P", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALWALLETLOAD", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "TOTALPOSWITHDRAWAL", nullable = true, length = 350)
    ...
    @Basic
    @Column(name = "ACCOUNTID", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "MOSTFREQUENTLOCATION", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "DATEACTIVATED", nullable = true, length = 350)
    ...
    public boolean equals(Object o) {
        ...
        MomTransactionSummary that = (MomTransactionSummary) o;
        ...
        if (totalgsmexpenditure != null ? !totalgsmexpenditure.equals(that.totalgsmexpenditure) : that.totalgsmexpenditure != null)
            return false;
        if (totalamdebits != null ? !totalamdebits.equals(that.totalamdebits) : that.totalamdebits != null)
            return false;
        if (totalamcredits != null ? !totalamcredits.equals(that.totalamcredits) : that.totalamcredits != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (totalamdebits != null ? totalamdebits.hashCode() : 0);
        result = 31 * result + (totalamcredits != null ? totalamcredits.hashCode() : 0);
