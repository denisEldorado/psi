 ...
 */
@Entity
@Table(name = "FCT_MOM_GSMITEMISED")
public class MomGsmItemised {
    private Long id;
    ...
    @Id
    @SequenceGenerator(name = "FCT_MOM_GSMITEMISED_SEQ_GEN", sequenceName = "FCT_MOM_GSMITEMISED_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "FCT_MOM_GSMITEMISED_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object o) {
        ...
        MomGsmItemised that = (MomGsmItemised) o;
