 ...
 */
@Entity
@Table(name = "ADM_ROLE_PRIVILEGES")
public class RolePrivileges {
    private Long id;
    private Priviledges privilegeid;
    //private Long roleid;
    ...
    public RolePrivileges(int status, Roles roleid, Priviledges priviledgeid) {
        this.status = status;
        this.roleid = roleid;
    ...
    @Id
    @SequenceGenerator(name = "ADM_ROLE_PRIVILEGES_SEQ_GEN", sequenceName = "ADM_ROLE_PRIVILEGES_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "ADM_ROLE_PRIVILEGES_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    ...
    public Priviledges getPrivilegeid() {
        return privilegeid;
    }

    public void setPrivilegeid(Priviledges privilegeid) {
