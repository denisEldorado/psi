...
@XmlType(name = "personalProfile", propOrder = {"alienID", "crn", "dateOfBirth", "dateOfDeath", "drivingLicenseNo", "fullName", "gender", "healthInsuranceNo", "maritalStatus", "nationalID", "nationality", "otherNames", "passportNo", "pin", "salutation", "serviceID", "socialSecurityNo", "surname"})
