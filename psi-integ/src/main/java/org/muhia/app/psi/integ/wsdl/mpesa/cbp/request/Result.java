...
@XmlType(name = "Result", namespace = "http://api-v1.gen.mm.vodafone.com/mminterface/result", propOrder = {
    "resultType",
    "resultCode",
    "resultDesc",
...
public class Result {
    ...
    @XmlElementRef(name = "ResultType", namespace = "http://api-v1.gen.mm.vodafone.com/mminterface/result", type = JAXBElement.class, required = false)
    protected JAXBElement<BigInteger> resultType;
    @XmlElement(name = "ResultCode", required = true)
    protected String resultCode;
    @XmlElement(name = "ResultDesc")
    protected String resultDesc;
    @XmlElementRef(name = "OriginatorConversationID", namespace = "http://api-v1.gen.mm.vodafone.com/mminterface/result", type = JAXBElement.class, required = false)
    ...
    public static class ReferenceData {
        ...
        @XmlElement(name = "ReferenceItem", namespace = "http://api-v1.gen.mm.vodafone.com/mminterface/result", required = true)
    ...
    public static class ResultParameters {
        ...
        @XmlElement(name = "ResultParameter", namespace = "http://api-v1.gen.mm.vodafone.com/mminterface/result")
