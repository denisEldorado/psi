...
@XmlType(name = "product153", propOrder = {"accountList", "alsoKnownAsList", "bouncedChequeList", "collateralList", "corporateProfile", "creditApplicationList", "directorList", "disputeStatementList", "emailList", "fraudList", "guaranteeList", "header", "phoneList", "physicalAddressList", "postalAddressList", "recentEnquiryList", "responseCode", "shareholderList", "summary"})
