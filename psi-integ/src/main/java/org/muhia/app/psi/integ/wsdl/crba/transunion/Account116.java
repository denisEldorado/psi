...
@XmlType(name = "account116", propOrder = {"accountClosedDate", "accountNo", "accountOpeningDate", "accountOwner", "accountStatus", "accountType", "arrearAmount", "arrearDays", "balanceAmount", "currency", "disputed", "groupName", "groupNumber", "hasDefaultHistory", "isMyAccount", "isNonPerforming", "joinLoanParticipants", "lastPaymentDate", "listingDate", "maturityDate", "pastDueDate", "principalAmount", "repaymentDuration", "repaymentTerm", "scheduledPaymentAmount", "tradeSector", "worstArrear"})
